...
const (
	...
	RepoService_IncrementArticleCount_FullMethodName = "/proto.RepoService/IncrementArticleCount"
)
...
type RepoServiceClient interface {
	...
	IncrementArticleCount(ctx context.Context, in *IncrementArticleCountRequest, opts ...grpc.CallOption) (*IncrementArticleCountResponse, error)
}
...
func (c *repoServiceClient) IncrementArticleCount(ctx context.Context, in *IncrementArticleCountRequest, opts ...grpc.CallOption) (*IncrementArticleCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IncrementArticleCountResponse)
	err := c.cc.Invoke(ctx, RepoService_IncrementArticleCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RepoServiceServer interface {
	...
	IncrementArticleCount(context.Context, *IncrementArticleCountRequest) (*IncrementArticleCountResponse, error)
...
func (UnimplementedRepoServiceServer) IncrementArticleCount(context.Context, *IncrementArticleCountRequest) (*IncrementArticleCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementArticleCount not implemented")
}
...
func _RepoService_IncrementArticleCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IncrementArticleCountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RepoServiceServer).IncrementArticleCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RepoService_IncrementArticleCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepoServiceServer).IncrementArticleCount(ctx, req.(*IncrementArticleCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RepoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IncrementArticleCount",
			Handler:    _RepoService_IncrementArticleCount_Handler,
		},
	},
