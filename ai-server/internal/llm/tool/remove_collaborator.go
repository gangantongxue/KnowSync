...
// Info 返回工具元信息.
func (r *RemoveCollaborator) Info(_ context.Context) (*schema.ToolInfo, error) {
...
// InvokableRun 执行工具调用.
func (r *RemoveCollaborator) InvokableRun(ctx context.Context, arguments string, _ ...tool.Option) (string, error) {
