...
// 注意：会话是从好友和群组数据聚合出来的视图，不是独立的数据库表.
...
func (r *ConversationRepo) GetFriendConversations(ctx context.Context, userID string) ([]schema.Friend, error) {
...
func (r *ConversationRepo) GetGroupConversations(ctx context.Context, userID string) ([]GroupConversationInfo, error) {
...
func (r *ConversationRepo) UpdateFriendLastReadSeqID(ctx context.Context, userID, friendID string, seqID uint64) error {
...
func (r *ConversationRepo) UpdateGroupMemberLastReadSeqID(ctx context.Context, groupID, userID string, seqID uint64) error {
	return r.db.WithContext(ctx).
...
func (r *ConversationRepo) ToggleFriendPin(ctx context.Context, userID, friendID string) (bool, error) {
...
func (r *ConversationRepo) ToggleGroupPin(ctx context.Context, groupID, userID string) (bool, error) {
...
func (r *ConversationRepo) DeleteFriendRelation(ctx context.Context, userID, friendID string) error {
	return r.db.WithContext(ctx).
