...
func (s *GroupService) CreateGroup(ctx context.Context, ownerID, name, avatar string, memberIDs []string) (*schema.Group, error) {
	now := time.Now().Unix()
	group := &schema.Group{
		Name:      name,
		Avatar:    avatar,
...
func (s *GroupService) GetGroupInfo(ctx context.Context, groupID, userID string) (*schema.Group, bool, error) {
...
func (s *GroupService) UpdateGroup(ctx context.Context, groupID, userID, name, avatar string) error {
	group, err := s.Repo.Group.GetGroupByID(ctx, groupID)
	if err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
...
func (s *GroupService) AddMembers(ctx context.Context, groupID, operatorID string, memberIDs []string) error {
...
// RemoveMember 移除成员.
func (s *GroupService) RemoveMember(ctx context.Context, groupID, operatorID, targetUserID string) error {
...
func (s *GroupService) TransferOwnership(ctx context.Context, groupID, currentOwnerID, newOwnerID string) error {
...
func (s *GroupService) SetAdmin(ctx context.Context, groupID, operatorID, targetUserID string) error {
	if operatorID == targetUserID {
...
func (s *GroupService) RemoveAdmin(ctx context.Context, groupID, operatorID, targetUserID string) error {
	if operatorID == targetUserID {
...
func (s *GroupService) GetGroupMembers(ctx context.Context, groupID, userID string) ([]schema.GroupMember, error) {
	_, err := s.Repo.GroupMember.GetMember(ctx, groupID, userID)
	if err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
...
func (s *GroupService) GetUserGroups(ctx context.Context, userID string) ([]repository.UserGroupInfo, error) {
